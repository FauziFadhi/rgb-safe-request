...
export declare abstract class SafeRequest {
    ...
    abstract patch<T>(url: string, data?: unknown, config?: CONFIG): Promise<AxiosResponse<T>>;
    abstract put<T>(url: string, data?: unknown, config?: CONFIG): Promise<AxiosResponse<T>>;
    abstract post<T>(url: string, data?: unknown, config?: CONFIG): Promise<AxiosResponse<T>>;
}
